...
twenty through the full two-block protocol, meeting that recruitment target exactly and giving nineteen
workstation pairs and seventeen driving pairs, with the decision table applied
as committed. The answers:
a 3.07-point accuracy gain on a real-hardware task, real, significant, and adequately powered, but
...
\item \textbf{Sample, power, and Block B's response-criterion qualification.} The pre-registered
  ...
  and 95\% achieved power (one-tailed, against a design target set two-tailed). Block B lost three
  ...
  The pooled Block B
  estimate carries a response-criterion qualification and sits at 67.5\% achieved power (Chapter 5,
