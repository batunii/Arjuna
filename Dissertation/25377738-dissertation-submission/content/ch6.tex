...
the 20--30$^{\circ}$ band the system's own detection-gated geometry predicts, supported at 89.0\%
...
\item \textbf{Sample, power, and Block B's response-criterion qualification.} The pre-registered
  twenty completed
  the full two-block protocol, and the primary hypothesis and the 20--30$^{\circ}$ band sit at 79.8\%
...
The evaluation apparatus built to do that is part of the contribution: a single primary endpoint
with a smallest effect size of interest, equivalence margins for safety claims, pilot gates, and a
decision table committed before data collection. Its artefacts are documents and thresholds rather
than equipment, and it converts every outcome into a claim with stated bounds.
