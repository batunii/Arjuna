...
passthrough the user normally sees: a 1280$\times$960 stream per camera covering roughly
...
\item \textbf{C2: Reference implementation.} An open, working multi-mode DR attention-guidance
  ...
  rendered as an absence in the overlay, a world-direction sampling scheme that lets a
  single-camera feed fuse binocularly, motion-coupled comfort suppression, and ten peripheral treatments
