...
participants completed the full two-block protocol, meeting the recruitment target exactly. The workstation block
...
at 88\% and 95\% achieved power (one-tailed) for the primary contrast and the pre-registered
eccentricity band.
