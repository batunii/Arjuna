...
\item \textbf{C2: Reference implementation.} An open, working multi-mode DR attention-guidance system
  on Quest 3 passthrough, with the code publicly available at
  \url{https://github.com/batunii/Arjuna}: the world-locked focus-window-as-absence architecture, world-direction
