...
\item \textbf{RQ2 (secondary).} Can salience re-grading improve detection of relevant peripheral
  ...
  prediction is tested by equivalence, so failing it would be a conclusive negative finding rather
  than an ambiguous null.
...
\item \textbf{C3: Pre-registered user study, carried to analysis.} A within-subjects study designed
  so that any outcome is informative: one adequately powered primary hypothesis, a safety check with
  ...
  reported with the full analysis of the seventeen workstation and fifteen driving pairs collected,
