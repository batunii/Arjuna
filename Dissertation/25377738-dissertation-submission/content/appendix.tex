...
The following table was pre-committed before data collection. Collection ended at seventeen
workstation and fifteen driving pairs, two short of the pre-registered twenty (the deviation is
reported in Chapter 5, Sections 5.3 and 5.7), and the table is applied to that final sample.
