...
(Section 4.5.2). These are the component defaults; the scene the user study ran serialises
18$^{\circ}$ for the dark path and 24$^{\circ}$ for the colour-pop path, against an
8$^{\circ}\times$6$^{\circ}$ window, which is the geometry Chapter 5, Section 5.7.3 reads its
...
same world point. The mono image behaves like a texture painted onto the world shell, which the
