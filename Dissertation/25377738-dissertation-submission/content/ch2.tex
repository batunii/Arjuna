...
gaze to themselves. This dissertation's ColorPop inherits the philosophy directly, accept visibility,
preserve exploration, re-grade rather than annotate, and applies the saturation-and-luminance half of
the recipe on its salient-colour channel; the sigmoidal contrast stage is implemented but not enabled
on the evaluated path (Chapter 4, Section 4.5.2). The critical difference is platform. Sutton et al. built
