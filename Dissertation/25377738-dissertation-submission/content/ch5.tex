...
naive-pilot iteration used to tune stimulus parameters ahead of the frozen protocol, meeting the
recruitment target exactly. The target was set in analysed participants, and the pre-registered
exclusions applied below reduce the analysed sets below it: one pair is lost from the workstation
block and three from the driving block.
...
exclusions; twenty people were tested in all, meeting that target through the full
two-block protocol (Section 5.7). Inclusion criteria follow the approved ethics protocol: aged 18 or
...
full two-block protocol, meeting the target the design set exactly, so no supplementary
participants were needed. The completed sample delivers 88\% achieved power for the primary contrast
...
and everyone from P9 onward ran the 140-trial form. The change was made deliberately and for one
stated reason, to move performance off the ceiling the short form sat on, and the achieved data show
it partly worked. Across the five short-form participants the mean arm accuracy was 96.1\% with a
floor of 84.6\%, leaving little room to detect a benefit; across the fourteen who ran the 140-trial
...
ran the shorter form and the remaining fourteen ran the 140-trial form, and the two groups
...
real, adequately powered 3.07-point accuracy gain on a real-hardware task with real physical
