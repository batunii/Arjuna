...
pre-registered design that chapter specifies. Fourteen usable pairs exist for the workstation block
and thirteen for the driving block, against a target of twenty. Chapter 6, Section 6.11 reports what
those pairs show, explicitly as an interim analysis. Recruitment continues, achieved power at this $N$ is
...
Figure~\ref{fig:structure} sets out how the two parts fit together.
