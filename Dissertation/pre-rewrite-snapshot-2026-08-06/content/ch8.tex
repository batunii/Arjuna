...
underway. Against the target of twenty, fourteen usable pairs are in for Block A and thirteen for
Block B, with interim results reported in
...
The system exists and runs on target hardware. The hypothesis has moved past waiting: fourteen
workstation pairs and thirteen driving pairs have already tested it, and the interim direction is
favourable, though the
