...
ancestor in FocalSpace \citep{yao2013}, discussed in Section 2.3, which established that suppressing background
...
dissertation addresses in whole or part. Table~\ref{tab:gaps} states each gap and what this work does
about it.
